document.addEventListener('DOMContentLoaded', () => {
    ...
    generateBtn.addEventListener('click', generateMeme); // Corrected function name
    tryMoreBtn.addEventListener('click', generateMeme);    // Corrected function name
    ...
    // --- CORE FUNCTIONS ---
    async function generateMeme() { // Corrected function name
